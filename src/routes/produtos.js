...
router.get('/sugestao-preco', requireAdmin, controller.sugestaoPreco);
router.get('/giro', controller.giro);
router.get('/parados', controller.parados);
router.get('/pricing', requireAdmin, controller.pricingProfissional);
router.get('/pricing-profissional', requireAdmin, controller.pricingProfissional);
router.get('/lucro', requireAdmin, controller.lucroPorProduto);
router.get('/alerta-prejuizo', requireAdmin, controller.alertaPrejuizo);
router.get('/inteligencia', requireAdmin, controller.inteligencia);
